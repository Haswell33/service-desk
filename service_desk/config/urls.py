...
urlpatterns = [
    ...
    path('password-change/',
         auth_views.PasswordChangeView.as_view(
             template_name='password-change/password-change.html',
             success_url=reverse_lazy('password_change_success')),
         name='password_change'),
    path('password-change/success',
         auth_views.PasswordChangeDoneView.as_view(
             template_name='password-change/password-change-success.html'),
    ...
    path('password-reset/sent',
         auth_views.PasswordResetDoneView.as_view(
             template_name='password-reset/password-reset-sent.html'),
    ...
    path('password-reset/success',
         auth_views.PasswordResetCompleteView.as_view(
             template_name='password-reset/password-reset-success.html'),
